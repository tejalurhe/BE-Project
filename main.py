...
label_l1 = tk.Label(root, text="Crop Disease & Pest Identification System",font=("Times New Roman", 30, 'bold'),
                    background="#3CB371", fg="white", width=60, height=1)
...
button1 = tk.Button(root, text="Crop Detection", command=plant, width=20, height=1,font=('times', 20, ' bold '), bg="#DC143C", fg="white")
